Feature:Clientele Investment plan Functionality
  ...
  Scenario Outline: User capture Clientele Wealth Plan(GSD) Cover for different age
    ...
    Then User Add payer details By Capturing, "<PayerTitle>", "<PayerName>", "<PayerSurname>", "<PayerID>", "<ConfirmPayerID>", "<PayerRelation>", "<BankName>", "<BranchCode>", "<AccountType>", "<AccountNumber>", "<ConfirmAccount>", "<MobileNumber>", "<IsPayerEmployee>"
    When user add Government details if selected yes, "<EmployeeNumber>", "<Department>", "<Authorised>", "<DebitDay>", "<DebitDate>"
    ...
    Examples:
      ...
      | WRambau  | clientele#2023 | Clientele Wealth Plan     |       Mr       | Sansa     | Mills         |       Yes         | 9802035521087 | 9802035521087 | Up to 3,000   | Sales and services | Matric    | 0601234231 | Plot 30 ward 55  | 1234       |Miss        | Joy       | McGregor     | 9704015949181 | 9704015949181  | Sister        |    25     | 25 Jan 2024 | CAPITEC BANK LTD | 470010     | Savings Account | 1234          | 1234           | 0601234230   |       Yes        | 22694064              |  National Department Of Home Affairs          |    Yes        | Member Estate       |         No                |           No                           | Premium R400/ Cover R0 |